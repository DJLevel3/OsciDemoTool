...
#define DEMO_SECTIONS 8 // How many sections to put in the demo
...
#define CUBE_SECTION 2
#define CUBE_SECONDS 32

#define PLASMA_SECTION 3
#define PLASMA_SECONDS 12

#define BALL_SECTION 4
#define BALL_SECONDS 64

#define MID_SECTION 5
#define MID_SECONDS 8

#define PLASMA2_SECTION 6
#define PLASMA2_SECONDS 8

#define GREETZ_SECTION 7
#define GREETZ_SECONDS 34

#define AUDIO_SECONDS (INTRO_SECONDS + TEXT_SECONDS + CUBE_SECONDS + PLASMA_SECONDS + BALL_SECONDS + MID_SECONDS + PLASMA2_SECONDS + GREETZ_SECONDS)
